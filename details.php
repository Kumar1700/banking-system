...
<head>
  ...
  <title>Kumar - Customer Details</title>
</head>

<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark ">
    <a class="navbar-brand" href="Kumar.php">Kumar<i class="fa fa-university" aria-hidden="true"></i></a>
    ...
    <div id="social" class="social-icons">
      <ul class="h-list social-icons-contact">
        ...
        <li>
          <a href=mailto:kumarrh2000@gmaSil.com" target="_blank">
